                ...
                <div className="container">
                    <div className="row justify-content-center text-center gy-4">
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg1.png"} title={"Translation of Banking Documents for Bank of Oman Arab – 2023"} desc={`In 2023, Trans-Gate handled the translation of a series of critical documents for
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg2.png"} 
...
international standards for legal translation.`} />
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg3.png"}
...
while adhering to the highest standards of quality and review.`} />
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg4.png"}
...
meticulous review for consistency and legal precision.`} />
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg5.png"}
                             title={""}
                              desc={``} />
                        </div>
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg6.png"}
...
their work to meet publication and academic review standards.`} />
                        ...
                        <div className="col-md-6 col-11">
                            <WorkCard img={"images/workCardImg7.png"}
